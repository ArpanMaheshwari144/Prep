...
- ★ **Delivery-tools:** [01_DELIVERY](04_HLD/01_DELIVERY.md) — "kaise bolna" playbook + SHABD (word-freeze se bachne ko) · **[02_TRADEOFFS](04_HLD/02_TRADEOFFS.md)** — 15 jode jo har design me ghoomte (A vs B + wajah + bolne-wali line)
...
- **[RAW_DRILL](04_HLD/RAW_DRILL)** — bolke-practice + reflex — [00_DRILL](04_HLD/RAW_DRILL/00_DRILL.md) (need→block reflex + kyun/kaise Q&A) · [01 design-practice-log](04_HLD/RAW_DRILL/01_DESIGN_PRACTICE_LOG.md) (bolke kiye design)
