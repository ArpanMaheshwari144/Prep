...
- ★ **Delivery-tools (pehle ye):** [HLD_APPROACH_DELIVERY](04_HLD/HLD_APPROACH_DELIVERY.md) — "kaise bolna" playbook (rail · meta-moves · anjaan-design · darr-jawab) · [INTERVIEW_FRAMEWORK](04_HLD/INTERVIEW_FRAMEWORK.md) · [SPEAKING_VOCAB](04_HLD/SPEAKING_VOCAB.md) (word-freeze se bachne ko) · **[TRADEOFFS](04_HLD/TRADEOFFS.md)** — 15 jode jo har design me ghoomte (A vs B + wajah + bolne-wali line)
