// ============================================================
// FIND PIVOT INDEX — BLANK REDO (copy-pen pehle!)
// ============================================================
// nums[] diya. wo INDEX dhoondo jahan LEFT sabhi elements ka sum ==
...
//  dhyan: check pehle karo, PHIR leftSum += nums[i]. koi na mile -> -1.
// ============================================================
