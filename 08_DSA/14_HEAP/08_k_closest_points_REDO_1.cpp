// ============================================================
// K CLOSEST POINTS TO ORIGIN — (LeetCode 973, Medium)   [HEAP #8 · max-heap of size k]  — REDO_1
// ============================================================
// points[] me har element ek point [x,y]. Origin O(0,0) ke sabse PAAS wale K points lautao.
// "paas" = doori = x*x + y*y  (√ ki zaroorat nahi — sirf compare karna hai). Order koi bhi.
//
//   [[1,3],[-2,2]] , k=1              -> [[-2,2]]
