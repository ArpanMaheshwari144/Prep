...
```
   ...
   - Search in Rotated Sorted Array (mid pe: ek half HAMESHA sorted -> pehchaan -> target us range me? narrow) — 5/5.
     redo: [x] BLANK-no-peek 7-Jul (6/6, khud se, no-peek -> LOCKED; pichhla peek sirf confusion-clear tha) [ ] +7din
