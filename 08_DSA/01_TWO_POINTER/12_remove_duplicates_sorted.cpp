...
// ---- ARPAN KI APPROACH ----
//  MOVE-ZEROES ka cousin: slow = write-index (unique tak), fast = scan.
//  wahan 0 dekhte the, yahan DUPLICATE dekhte: agar nums[slow] != nums[fast] (naya unique mila) ->
//  pehle slow++ (agle dupe element pe jao), phir nums[slow] = nums[fast] (naya unique wahan rakho).
