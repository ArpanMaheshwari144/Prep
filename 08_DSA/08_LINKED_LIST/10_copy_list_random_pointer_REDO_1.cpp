// ============================================================
// COPY LIST WITH RANDOM POINTER — (LeetCode 138)   [REDO_1 — blank]
// ============================================================
...
//
// FAMILY (nudge, baaki khud): hashmap(old->new) 2-pass — pehle saare new
//   nodes bana + mapping bharo, phir dobara ghoom ke random wire karo.
// ============================================================
#include <bits/stdc++.h>
using namespace std;
