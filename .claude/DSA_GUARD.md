...
code/answer/mechanism KABHI spill nahi, usko khud derive karne do. (2) NAYA pattern (cold nahi banta, koi
nahi banata pehli baar) -> KHUL ke sikhao, phir TURANT set karo: "aaj seekh, kal BLANK REDO -> tab tera."
...
- METRIC: "samjha? + redo-pe-aa-raha?"  -- NA "solo/cold/khud-se" (ye zeher, ego-trigger).
